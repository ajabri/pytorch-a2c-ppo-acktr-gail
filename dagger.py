...
def evaluate_policy(env,
    ...
    for ep in range(num_episodes):
        ...
        while t < horizon and (done == False or terminate_at_done == False):
            ...
            act = policy(torch.from_numpy(o).float().to(device))
...
def main(**kwargs):
    ...
    class ImitateTorch:
        ...
        def evaluate(self, env):
            ...
            print('student success_rate', evaluate_success(kwargs['env_name'], all_paths))
...
if __name__ == "__main__":
    sweep_params = {
        ...
        'num_rollouts': 200,
        'num_processes': 1,
        'num_steps': 100, #200 for relocate
        'num_mini_batch': 1,
        'log_interval': 1,
